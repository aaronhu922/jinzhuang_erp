...
<table id="dg" title="采购管理" class="easyui-datagrid" pagination="true"
    ...
    <tr>
        ...
        <th field="articleTitle" width="200" align="center">采购类别</th>
        <th field="articleCreateDate" width="150" align="center">采购时间</th>
        <th field="addName" width="150" align="center">采购负责人</th>
        <th field="content" width="70" align="center"
            formatter="formatHref">订单总额
        </th>
    </tr>
    </thead>
</table>
