...
<table id="dg" title="客户信息管理" class="easyui-datagrid" pagination="true"
    ...
    <tr>
        ...
        <th field="path" width="300" align="center" formatter="formatProPic">客户名称</th>
        <th field="time" width="150" align="center">客户联系方式</th>
        <th field="url" width="150" align="center">客户订单</th>
        <th field="url" width="150" align="center">未收款</th>
         <th field="url" width="150" align="center">未回收气瓶</th>       
