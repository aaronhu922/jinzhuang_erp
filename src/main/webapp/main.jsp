...
<div region="center">
    <div class="easyui-tabs" fit="true" border="false" id="tabs">
        <div title="首页" data-options="iconCls:'icon-home'">
                    ...
                    href=""
                    target="_blank" style="font-size: 20px;">瓶气回收提醒</a>
            </div>
            <div align="center" style="padding-top: 20px;"><a href=""
                                                              target="_blank"
                                                              style="font-size: 20px;">未回款订单查询</a></div>

            <div align="center" style="padding-top: 50px;"><a
                    href=""
                    target="_blank" style="font-size: 20px;">公司介绍</a>
            </div>
            <div align="center" style="padding-top: 20px;"><a
                    href=""
                    target="_blank" style="font-size: 20px;">联系方式</a>
            </div>
            <div align="center" style="padding-top: 50px">
                <font color="grey" size="10">锦庄气体有限公司产品信息化系统</font>
            </div>
        </div>
    </div>
</div>
<div region="west" style="width: 200px;height:500px;" title="系统导航"
     split="true">
    <div class="easyui-accordion">
        <div title="销售管理"
            ...
            <a
                    href="javascript:openTab(' 订单管理','allBooksManage.jsp','icon-wenzhang')"
                    class="easyui-linkbutton"
                    data-options="plain:true,iconCls:'icon-wenzhang'"
                    style="width: 150px;"> 订单管理</a>
        </div>
        <div title="客户管理" data-options="iconCls:'icon-shouye'"
             style="padding:10px">
            <a
                    href="javascript:openTab(' 客户列表','pictureManage.jsp?type=1&grade=1','icon-tupians')"
                    class="easyui-linkbutton"
                    data-options="plain:true,iconCls:'icon-tupian'"
                    style="width: 150px;"> 客户列表</a>
        </div>
        <div title="采购管理" data-options="iconCls:'icon-shuji'"
             style="padding:10px">
            <a
                    href="javascript:openTab(' 全部采购订单','articleManage.jsp','icon-shuben')"
                    class="easyui-linkbutton"
                    data-options="plain:true,iconCls:'icon-shuben'"
                    style="width: 150px;">采购订单</a>
        </div>
        <div title="系统管理" data-options="iconCls:'icon-item'"
            ...
            <a href="javascript:openTab(' 用户列表','userManage.jsp','icon-lxr')"
               ...
               data-options="plain:true,iconCls:'icon-lxr'" style="width: 150px;">
                用户列表</a><a href="javascript:logout()"
                            class="easyui-linkbutton"
